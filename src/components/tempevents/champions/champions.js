...
function champions() {
  return (
    <div className="bg-sky-600 min-h-screen flex flex-col">
      ...
      />
      <div className="m-10">
        <section className="text-gray-100 text-center space-y-3">
          <p>
            La Liga de Campeones de la UEFA es una competición anual de fútbol
            de clubes organizada por la Unión de Asociaciones Europeas de Fútbol
          ...
          <p>
            ...
            1992. El formato actual de la competición consta de una fase de
            grupos seguida de una fase eliminatoria. La fase de grupos consta de
            32 equipos divididos en ocho grupos de cuatro. Los dos primeros de
            cada grupo pasan a la fase eliminatoria, que consta de los octavos
            de final, los cuartos de final, las semifinales y la final.
          </p>
          <p>
            ...
            ocasiones. Otros equipos de éxito son el Bayern de Múnich (6
            títulos), el AC Milan (7 títulos), el Liverpool (6 títulos) y el
            Barcelona (5 títulos).
          </p>
          <p>
        ...
        <section>
          ...
          <ul className="text-gray-100 list-disc space-y-3">
            <li>
              La primera final de la UEFA Champions League se celebró en 1956 y
              fue ganada por el Real Madrid contra el Stade Reims.
            </li>
            <li>
              El equipo más laureado en la historia de la Liga de Campeones de
              la UEFA es el Real Madrid, que ha ganado la competición en 14
              ocasiones.
            </li>
            <li>
              La final de la Liga de Campeones de la UEFA más vista fue la de
              2019 entre el Liverpool y el Tottenham Hotspur, que fue seguida
              por aproximadamente 400 millones de personas en todo el mundo.
            </li>
          </ul>
        </section>
      </div>
