...
const imagesDepositos = [
  ...
  },
  {
    ...
    descriptionTitle: "Desde el Cajero de Betcris:",
    description:
      "Haz clic en 'PayCash', seguido ingresa el monto a depositar y haz clic en 'Generar referencia', luego copia el código de 16 dígitos que el sistema proporciona. Visita el sistema de banca en línea de tu banco que tiene el servicio de PayCash activo, selecciona 'Pago de Servicios' o 'Pago a Compañías' y luego 'PayCash', seguido ingresa el número de referencia, el monto a pagar y por último confirma el pago.",
  },
  {
    img: Tarjetas,
  ...
  },
  {
    ...
    descriptionTitle: "Desde el Cajero de Betcris:",
    description:
      "Haz clic en 'Fri', seguido ingresa el monto que deseas depositar, el número de teléfono registrado en Fri y haz clic en 'Depositar', genera la orden de depósito, luego ingresa a tu billetera Fri y valida la orden de Betcris, y por último confirma la orden de depósito para acreditar tus fondos.",
  },
];
