// https://bcautomatizaciones.com/website/#/retiros/generalreten

import React, { useState } from "react";
import { retDataEn } from "./RetData";
import LogoBC from "../../../../img/logo-blanco.png";
import { motion } from "framer-motion";

const RetMenuES = () => {
  const retData = retDataEn;
            ...
            <div className="p-5 m-5 bg-sky-900 bg-opacity-20 rounded-2xl shadow-black shadow-sm">
              <div className="text-sm lg:text-base text-white text-center">
                <motion.h1
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 1, delay: retData.length * 0.3 }} // Aplica un retardo para que la animación del h1 se inicie después de la animación de los botones
                >
