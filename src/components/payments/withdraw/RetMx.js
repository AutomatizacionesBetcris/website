...
const imagesRetiros = [
  ...
  },
  {
    ...
    description: [
      ...
      "Ingresa tu información, la misma que usaste en la aplicación móvil: número de teléfono (incluye el código de tu país sin utilizar el signo de “+” al principio), correo electrónico e identificación personal",
      "Haz clic en 'Retirar'",
    ],
  },
  {
